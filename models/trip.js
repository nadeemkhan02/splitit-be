...
const validateTrip = (trip) => {
    ...
    const schema = joi.object({
        ...
        tripDate: joi.date().required().greater(startofToday)?.message("Trip date cannot be a past date"),
        tripStatus: joi.string().required().valid("pending", "completed", "cancelled", "ongoing"),
